package trainingmanagement.TrainingManagement.util;
...
public class JwtUtil {
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        final String empName = getUsernameFromToken(token);
        return (empName.equals(userDetails.getUsername()) && !isTokenExpired(token));
    }
